    ...
    <div>
        <div class="layout">
            <div class="layout-topbar clearfix">
                <div class="layout-name" :class="{'sider-mini': isCollapse}">
                    <router-link class="full" to="/" v-if="!isCollapse">SBA-M lIBRARY SYSTEM</router-link>
        ...
        <div class="layout-panel">
            <div class="layout-content">
                ...
                <div class="layout-footer">Ashin Indavudha @ 2020</div>
            </div>
        </div>
    </div>
</div>
        ...
        methods: {
            ...
            handleLogout() {
                ...
                this.$confirm('Do you Continue?', 'Signout', {
                    ...
                    vm.$root.store.dispatch('handleLogout', true)
...
<style>
    ...
    .layout-body.sider-mini .el-menu .el-submenu__icon-arrow, .layout-body.sider-mini .el-menu .nav-next {
        display: none;
    }
